...
For individuals who completed three baseline tests, the verbal memory composite score was statistically significantly different, *F*(1.99, 5,822.57) = 236.46, *p* < .0001, generalized eta squared = 0.03. 

Post-hoc analyses with a Bonferroni adjustment revelated that all pairwise comparisons, between baseline test administrations, were statistically significantly different (*p* < .05). 
